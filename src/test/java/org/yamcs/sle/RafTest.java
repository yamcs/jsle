...
public class RafTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        RafServiceUserHandler rsuh = new RafServiceUserHandler(isp1Authentication, responderPortId, initiatorId, DeliveryMode.rtnTimelyOnline, 1, c);
    ...
    static class MyConsumer implements FrameConsumer {
        ...
        public void onLossFrameSync(CcsdsTime time, LockStatus carrier, LockStatus subcarrier, LockStatus symbolSync) {
            System.out.println("onLossFrameSync time: "+time+": carrier: "+carrier+" subcarrier: "+subcarrier+" symbolSync: "+symbolSync);
        }
    ...
    static class MyMonitor implements RafSleMonitor {

        @Override
        public void onRafStatusReport(RafStatusReportInvocation rsr) {
