...
public class RocfStartReturn implements BerType, Serializable {
	...
	public static class Result implements BerType, Serializable {
		...
		private DiagnosticRocfStart negativeResult = null;
		...
		public void setNegativeResult(DiagnosticRocfStart negativeResult) {
			this.negativeResult = negativeResult;
		}

		public DiagnosticRocfStart getNegativeResult() {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
				...
				negativeResult = new DiagnosticRocfStart();
	...
	public RocfStartReturn() {
	}

	public RocfStartReturn(byte[] code) {
		this.code = code;
	}
