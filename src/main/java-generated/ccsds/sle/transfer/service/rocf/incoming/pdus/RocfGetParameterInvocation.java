...
public class RocfGetParameterInvocation implements BerType, Serializable {
	...
	private RocfParameterName rocfParameter = null;
	
	public RocfGetParameterInvocation() {
	}

	public RocfGetParameterInvocation(byte[] code) {
		this.code = code;
	}
	...
	public void setRocfParameter(RocfParameterName rocfParameter) {
		this.rocfParameter = rocfParameter;
	}

	public RocfParameterName getRocfParameter() {
		return rocfParameter;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += rocfParameter.encode(reverseOS, true);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(RocfParameterName.tag)) {
			rocfParameter = new RocfParameterName();
			subCodeLength += rocfParameter.decode(is, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (rocfParameter != null) {
			sb.append("rocfParameter: ").append(rocfParameter);
		}
		else {
			sb.append("rocfParameter: <empty-required-field>");
		}
