...
public class RequestedControlWordTypeNumber extends BerInteger {

	private static final long serialVersionUID = 1L;

	public RequestedControlWordTypeNumber() {
	}

	public RequestedControlWordTypeNumber(byte[] code) {
		super(code);
	}

	public RequestedControlWordTypeNumber(BigInteger value) {
		super(value);
	}

	public RequestedControlWordTypeNumber(long value) {
		super(value);
	}
