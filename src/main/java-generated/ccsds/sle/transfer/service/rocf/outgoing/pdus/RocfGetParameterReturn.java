...
public class RocfGetParameterReturn implements BerType, Serializable {
	...
	public static class Result implements BerType, Serializable {
		...
		private RocfGetParameter positiveResult = null;
		private DiagnosticRocfGet negativeResult = null;
		...
		public void setPositiveResult(RocfGetParameter positiveResult) {
			this.positiveResult = positiveResult;
		}

		public RocfGetParameter getPositiveResult() {
			return positiveResult;
		}

		public void setNegativeResult(DiagnosticRocfGet negativeResult) {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 0)) {
				...
				positiveResult = new RocfGetParameter();
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
				codeLength += BerLength.skip(is);
				negativeResult = new DiagnosticRocfGet();
	...
	public RocfGetParameterReturn() {
	}

	public RocfGetParameterReturn(byte[] code) {
		this.code = code;
	}
