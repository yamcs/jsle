...
public class Notification implements BerType, Serializable {
	...
	private RocfProductionStatus productionStatusChange = null;
	...
	public void setProductionStatusChange(RocfProductionStatus productionStatusChange) {
		this.productionStatusChange = productionStatusChange;
	}

	public RocfProductionStatus getProductionStatusChange() {
	...
	public int decode(InputStream is, BerTag berTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 1)) {
			productionStatusChange = new RocfProductionStatus();
