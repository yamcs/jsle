...
public class RocfSyncNotifyInvocation implements BerType, Serializable {
	...
	public RocfSyncNotifyInvocation() {
	}

	public RocfSyncNotifyInvocation(byte[] code) {
		this.code = code;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += notification.encode(reverseOS);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		subCodeLength += notification.decode(is, berTag);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (notification != null) {
			...
			sb.append("notification: <empty-required-field>");
		}
