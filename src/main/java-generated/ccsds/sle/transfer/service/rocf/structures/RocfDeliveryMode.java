...
public class RocfDeliveryMode extends DeliveryMode {

	private static final long serialVersionUID = 1L;

	public RocfDeliveryMode() {
	}

	public RocfDeliveryMode(byte[] code) {
		super(code);
	}

	public RocfDeliveryMode(BigInteger value) {
		super(value);
	}

	public RocfDeliveryMode(long value) {
		super(value);
	}
