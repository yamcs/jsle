...
public class RafProductionStatus extends BerInteger {

	private static final long serialVersionUID = 1L;

	public RafProductionStatus() {
	}

	public RafProductionStatus(byte[] code) {
		super(code);
	}

	public RafProductionStatus(BigInteger value) {
		super(value);
	}

	public RafProductionStatus(long value) {
		super(value);
	}
