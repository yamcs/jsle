...
public class RafTransferDataInvocation implements BerType, Serializable {
	...
	private FrameQuality deliveredFrameQuality = null;
	private PrivateAnnotation privateAnnotation = null;
	private SpaceLinkDataUnit data = null;
	
	public RafTransferDataInvocation() {
	}

	public RafTransferDataInvocation(byte[] code) {
		this.code = code;
	}
	...
	public void setDeliveredFrameQuality(FrameQuality deliveredFrameQuality) {
		this.deliveredFrameQuality = deliveredFrameQuality;
	}

	public FrameQuality getDeliveredFrameQuality() {
		return deliveredFrameQuality;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		codeLength += deliveredFrameQuality.encode(reverseOS, true);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(FrameQuality.tag)) {
			deliveredFrameQuality = new FrameQuality();
			subCodeLength += deliveredFrameQuality.decode(is, false);
			subCodeLength += berTag.decode(is);
		}
		else {
			throw new IOException("Tag does not match the mandatory sequence element tag.");
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (deliveredFrameQuality != null) {
			sb.append("deliveredFrameQuality: ").append(deliveredFrameQuality);
		}
		else {
			sb.append("deliveredFrameQuality: <empty-required-field>");
		}
