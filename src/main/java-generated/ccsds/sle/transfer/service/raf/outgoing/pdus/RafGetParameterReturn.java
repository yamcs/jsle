...
public class RafGetParameterReturn implements BerType, Serializable {
	...
	public static class Result implements BerType, Serializable {
		...
		private RafGetParameter positiveResult = null;
		private DiagnosticRafGet negativeResult = null;
		...
		public void setPositiveResult(RafGetParameter positiveResult) {
			this.positiveResult = positiveResult;
		}

		public RafGetParameter getPositiveResult() {
			return positiveResult;
		}

		public void setNegativeResult(DiagnosticRafGet negativeResult) {
			this.negativeResult = negativeResult;
		}

		public DiagnosticRafGet getNegativeResult() {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 0)) {
				...
				positiveResult = new RafGetParameter();
	...
	public RafGetParameterReturn() {
	}

	public RafGetParameterReturn(byte[] code) {
		this.code = code;
	}
