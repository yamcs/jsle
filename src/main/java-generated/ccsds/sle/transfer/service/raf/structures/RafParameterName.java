...
public class RafParameterName extends ParameterName {

	private static final long serialVersionUID = 1L;

	public RafParameterName() {
	}

	public RafParameterName(byte[] code) {
		super(code);
	}

	public RafParameterName(BigInteger value) {
		super(value);
	}

	public RafParameterName(long value) {
		super(value);
	}
