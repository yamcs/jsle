...
public class RafStatusReportInvocation implements BerType, Serializable {
	...
	private IntUnsignedLong errorFreeFrameNumber = null;
	private IntUnsignedLong deliveredFrameNumber = null;
	...
	private RafProductionStatus productionStatus = null;
	
	public RafStatusReportInvocation() {
	}

	public RafStatusReportInvocation(byte[] code) {
		this.code = code;
	}
	...
	public void setErrorFreeFrameNumber(IntUnsignedLong errorFreeFrameNumber) {
		this.errorFreeFrameNumber = errorFreeFrameNumber;
	}

	public IntUnsignedLong getErrorFreeFrameNumber() {
		return errorFreeFrameNumber;
	}

	public void setDeliveredFrameNumber(IntUnsignedLong deliveredFrameNumber) {
		this.deliveredFrameNumber = deliveredFrameNumber;
	}

	public IntUnsignedLong getDeliveredFrameNumber() {
	...
	public void setProductionStatus(RafProductionStatus productionStatus) {
		this.productionStatus = productionStatus;
	}

	public RafProductionStatus getProductionStatus() {
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		codeLength += deliveredFrameNumber.encode(reverseOS, true);
		
		codeLength += errorFreeFrameNumber.encode(reverseOS, true);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(IntUnsignedLong.tag)) {
			errorFreeFrameNumber = new IntUnsignedLong();
			subCodeLength += errorFreeFrameNumber.decode(is, false);
			subCodeLength += berTag.decode(is);
		}
		else {
		...
		if (berTag.equals(IntUnsignedLong.tag)) {
			deliveredFrameNumber = new IntUnsignedLong();
			subCodeLength += deliveredFrameNumber.decode(is, false);
			subCodeLength += berTag.decode(is);
		}
		else {
			throw new IOException("Tag does not match the mandatory sequence element tag.");
		...
		if (berTag.equals(RafProductionStatus.tag)) {
			productionStatus = new RafProductionStatus();
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (errorFreeFrameNumber != null) {
			sb.append("errorFreeFrameNumber: ").append(errorFreeFrameNumber);
		}
		else {
			sb.append("errorFreeFrameNumber: <empty-required-field>");
		}
		...
		if (deliveredFrameNumber != null) {
			sb.append("deliveredFrameNumber: ").append(deliveredFrameNumber);
		}
		else {
			sb.append("deliveredFrameNumber: <empty-required-field>");
		}
