...
public class PermittedFrameQualitySet implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.UNIVERSAL_CLASS, BerTag.CONSTRUCTED, 17);
	public byte[] code = null;
	private List<RequestedFrameQuality> seqOf = null;

	public PermittedFrameQualitySet() {
		seqOf = new ArrayList<RequestedFrameQuality>();
	}

	public PermittedFrameQualitySet(byte[] code) {
		this.code = code;
	}

	public List<RequestedFrameQuality> getRequestedFrameQuality() {
		if (seqOf == null) {
			seqOf = new ArrayList<RequestedFrameQuality>();
		}
		return seqOf;
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		while (subCodeLength < totalLength) {
			RequestedFrameQuality element = new RequestedFrameQuality();
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (seqOf == null) {
			...
			Iterator<RequestedFrameQuality> it = seqOf.iterator();
			if (it.hasNext()) {
				sb.append(it.next());
				while (it.hasNext()) {
					sb.append(",\n");
