...
public class FrameOrNotification implements BerType, Serializable {
	...
	private RafTransferDataInvocation annotatedFrame = null;
	private RafSyncNotifyInvocation syncNotification = null;
	...
	public void setAnnotatedFrame(RafTransferDataInvocation annotatedFrame) {
		this.annotatedFrame = annotatedFrame;
	}

	public RafTransferDataInvocation getAnnotatedFrame() {
		return annotatedFrame;
	}

	public void setSyncNotification(RafSyncNotifyInvocation syncNotification) {
		this.syncNotification = syncNotification;
	}

	public RafSyncNotifyInvocation getSyncNotification() {
	...
	public int decode(InputStream is, BerTag berTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 0)) {
			annotatedFrame = new RafTransferDataInvocation();
			codeLength += annotatedFrame.decode(is, false);
			return codeLength;
		}

		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
			syncNotification = new RafSyncNotifyInvocation();
