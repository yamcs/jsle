...
public class RequestedFrameQuality extends BerInteger {

	private static final long serialVersionUID = 1L;

	public RequestedFrameQuality() {
	}

	public RequestedFrameQuality(byte[] code) {
		super(code);
	}

	public RequestedFrameQuality(BigInteger value) {
		super(value);
	}

	public RequestedFrameQuality(long value) {
		super(value);
	}
