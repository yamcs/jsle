...
public class RafGetParameterInvocation implements BerType, Serializable {
	...
	private RafParameterName rafParameter = null;
	
	public RafGetParameterInvocation() {
	}

	public RafGetParameterInvocation(byte[] code) {
		this.code = code;
	}
	...
	public void setRafParameter(RafParameterName rafParameter) {
		this.rafParameter = rafParameter;
	}

	public RafParameterName getRafParameter() {
		return rafParameter;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += rafParameter.encode(reverseOS, true);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(RafParameterName.tag)) {
			rafParameter = new RafParameterName();
			subCodeLength += rafParameter.decode(is, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (rafParameter != null) {
			sb.append("rafParameter: ").append(rafParameter);
		}
		else {
			sb.append("rafParameter: <empty-required-field>");
		}
