...
public class Notification implements BerType, Serializable {
	...
	private RcfProductionStatus productionStatusChange = null;
	...
	public void setProductionStatusChange(RcfProductionStatus productionStatusChange) {
	...
	public int decode(InputStream is, BerTag berTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 1)) {
			productionStatusChange = new RcfProductionStatus();
