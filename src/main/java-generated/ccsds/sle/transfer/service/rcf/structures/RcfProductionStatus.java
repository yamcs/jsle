...
public class RcfProductionStatus extends BerInteger {

	private static final long serialVersionUID = 1L;

	public RcfProductionStatus() {
	}

	public RcfProductionStatus(byte[] code) {
		super(code);
	}

	public RcfProductionStatus(BigInteger value) {
		super(value);
	}

	public RcfProductionStatus(long value) {
		super(value);
	}
