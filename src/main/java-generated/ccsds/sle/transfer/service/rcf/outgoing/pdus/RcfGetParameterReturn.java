...
public class RcfGetParameterReturn implements BerType, Serializable {
	...
	public static class Result implements BerType, Serializable {
		...
		private RcfGetParameter positiveResult = null;
		private DiagnosticRcfGet negativeResult = null;
		...
		public void setPositiveResult(RcfGetParameter positiveResult) {
			this.positiveResult = positiveResult;
		}

		public RcfGetParameter getPositiveResult() {
			return positiveResult;
		}

		public void setNegativeResult(DiagnosticRcfGet negativeResult) {
			this.negativeResult = negativeResult;
		}

		public DiagnosticRcfGet getNegativeResult() {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 0)) {
				...
				positiveResult = new RcfGetParameter();
	...
	public RcfGetParameterReturn() {
	}

	public RcfGetParameterReturn(byte[] code) {
		this.code = code;
	}
