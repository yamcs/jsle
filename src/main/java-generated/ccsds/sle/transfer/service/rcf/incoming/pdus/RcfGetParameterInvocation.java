...
public class RcfGetParameterInvocation implements BerType, Serializable {
	...
	private RcfParameterName rcfParameter = null;
	
	public RcfGetParameterInvocation() {
	}

	public RcfGetParameterInvocation(byte[] code) {
		this.code = code;
	}
	...
	public void setRcfParameter(RcfParameterName rcfParameter) {
		this.rcfParameter = rcfParameter;
	}

	public RcfParameterName getRcfParameter() {
		return rcfParameter;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += rcfParameter.encode(reverseOS, true);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(RcfParameterName.tag)) {
			rcfParameter = new RcfParameterName();
			subCodeLength += rcfParameter.decode(is, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (rcfParameter != null) {
			sb.append("rcfParameter: ").append(rcfParameter);
		}
		else {
			sb.append("rcfParameter: <empty-required-field>");
		}
