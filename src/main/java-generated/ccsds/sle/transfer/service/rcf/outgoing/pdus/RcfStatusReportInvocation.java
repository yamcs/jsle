...
public class RcfStatusReportInvocation implements BerType, Serializable {
	...
	private RcfProductionStatus productionStatus = null;
	
	public RcfStatusReportInvocation() {
	}

	public RcfStatusReportInvocation(byte[] code) {
		this.code = code;
	}
	...
	public void setProductionStatus(RcfProductionStatus productionStatus) {
		this.productionStatus = productionStatus;
	}

	public RcfProductionStatus getProductionStatus() {
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(RcfProductionStatus.tag)) {
			productionStatus = new RcfProductionStatus();
