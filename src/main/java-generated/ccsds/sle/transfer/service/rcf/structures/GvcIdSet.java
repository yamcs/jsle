...
public class GvcIdSet implements BerType, Serializable {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.UNIVERSAL_CLASS, BerTag.CONSTRUCTED, 17);
	public byte[] code = null;
	private List<MasterChannelComposition> seqOf = null;

	public GvcIdSet() {
		seqOf = new ArrayList<MasterChannelComposition>();
	}

	public GvcIdSet(byte[] code) {
		this.code = code;
	}

	public List<MasterChannelComposition> getMasterChannelComposition() {
		if (seqOf == null) {
			seqOf = new ArrayList<MasterChannelComposition>();
		}
		return seqOf;
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		while (subCodeLength < totalLength) {
			MasterChannelComposition element = new MasterChannelComposition();
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (seqOf == null) {
			...
			Iterator<MasterChannelComposition> it = seqOf.iterator();
			if (it.hasNext()) {
