...
public class RcfStartReturn implements BerType, Serializable {
	...
	public static class Result implements BerType, Serializable {
		...
		private DiagnosticRcfStart negativeResult = null;
		...
		public void setNegativeResult(DiagnosticRcfStart negativeResult) {
			this.negativeResult = negativeResult;
		}

		public DiagnosticRcfStart getNegativeResult() {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
				...
				negativeResult = new DiagnosticRcfStart();
	...
	public RcfStartReturn() {
	}

	public RcfStartReturn(byte[] code) {
		this.code = code;
	}
