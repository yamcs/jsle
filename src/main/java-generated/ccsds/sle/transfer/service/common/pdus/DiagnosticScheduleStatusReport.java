...
public class DiagnosticScheduleStatusReport implements BerType, Serializable {
	...
	public DiagnosticScheduleStatusReport() {
	}

	public DiagnosticScheduleStatusReport(byte[] code) {
		this.code = code;
	}
