...
public class SleAcknowledgement implements BerType, Serializable {
	...
	public static class Result implements BerType, Serializable {
		...
		private Diagnostics negativeResult = null;
		...
		public void setNegativeResult(Diagnostics negativeResult) {
			this.negativeResult = negativeResult;
		}

		public Diagnostics getNegativeResult() {
		...
		public int encode(OutputStream reverseOS) throws IOException {
			...
			if (negativeResult != null) {
				codeLength += negativeResult.encode(reverseOS, false);
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 1)) {
				negativeResult = new Diagnostics();
				codeLength += negativeResult.decode(is, false);
				return codeLength;
			}
		...
		public void appendAsString(StringBuilder sb, int indentLevel) {
			...
			if (negativeResult != null) {
				sb.append("negativeResult: ").append(negativeResult);
				return;
			}
	...
	public SleAcknowledgement() {
	}

	public SleAcknowledgement(byte[] code) {
		this.code = code;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		codeLength += credentials.encode(reverseOS);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		subCodeLength += credentials.decode(is, berTag);
		subCodeLength += berTag.decode(is);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (credentials != null) {
			...
			credentials.appendAsString(sb, indentLevel + 1);
		}
		else {
			sb.append("credentials: <empty-required-field>");
		}
