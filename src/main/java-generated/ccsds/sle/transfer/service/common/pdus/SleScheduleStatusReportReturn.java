...
public class SleScheduleStatusReportReturn implements BerType, Serializable {
	...
	public static class Result implements BerType, Serializable {
		...
		private DiagnosticScheduleStatusReport negativeResult = null;
		...
		public void setNegativeResult(DiagnosticScheduleStatusReport negativeResult) {
			this.negativeResult = negativeResult;
		}

		public DiagnosticScheduleStatusReport getNegativeResult() {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
				...
				negativeResult = new DiagnosticScheduleStatusReport();
	...
	public SleScheduleStatusReportReturn() {
	}

	public SleScheduleStatusReportReturn(byte[] code) {
		this.code = code;
	}
