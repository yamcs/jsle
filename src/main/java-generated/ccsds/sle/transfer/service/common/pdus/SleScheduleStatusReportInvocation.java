...
public class SleScheduleStatusReportInvocation implements BerType, Serializable {
	...
	private ReportRequestType reportRequestType = null;
	
	public SleScheduleStatusReportInvocation() {
	}

	public SleScheduleStatusReportInvocation(byte[] code) {
		this.code = code;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += reportRequestType.encode(reverseOS);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		subCodeLength += reportRequestType.decode(is, berTag);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (reportRequestType != null) {
			sb.append("reportRequestType: ");
			reportRequestType.appendAsString(sb, indentLevel + 1);
		}
		else {
			sb.append("reportRequestType: <empty-required-field>");
		}
