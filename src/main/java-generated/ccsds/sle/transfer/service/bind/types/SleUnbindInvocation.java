...
public class SleUnbindInvocation implements BerType, Serializable {
	...
	private UnbindReason unbindReason = null;
	
	public SleUnbindInvocation() {
	}

	public SleUnbindInvocation(byte[] code) {
		this.code = code;
	}
	...
	public void setUnbindReason(UnbindReason unbindReason) {
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += unbindReason.encode(reverseOS, true);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(UnbindReason.tag)) {
			unbindReason = new UnbindReason();
			subCodeLength += unbindReason.decode(is, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (unbindReason != null) {
			sb.append("unbindReason: ").append(unbindReason);
		}
		else {
			sb.append("unbindReason: <empty-required-field>");
		}
