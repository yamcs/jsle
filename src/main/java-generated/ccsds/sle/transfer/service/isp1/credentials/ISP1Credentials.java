...
public class ISP1Credentials implements BerType, Serializable {
	...
	private BerOctetString theProtected = null;
	
	public ISP1Credentials() {
	}

	public ISP1Credentials(byte[] code) {
		this.code = code;
	}
	...
	public void setTheProtected(BerOctetString theProtected) {
		this.theProtected = theProtected;
	}

	public BerOctetString getTheProtected() {
		return theProtected;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += theProtected.encode(reverseOS, true);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerOctetString.tag)) {
			theProtected = new BerOctetString();
			subCodeLength += theProtected.decode(is, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (theProtected != null) {
			sb.append("theProtected: ").append(theProtected);
		}
		else {
			sb.append("theProtected: <empty-required-field>");
		}
