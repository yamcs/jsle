...
public class FspProductionStatus extends BerInteger {

	private static final long serialVersionUID = 1L;

	public FspProductionStatus() {
	}

	public FspProductionStatus(byte[] code) {
		super(code);
	}

	public FspProductionStatus(BigInteger value) {
		super(value);
	}

	public FspProductionStatus(long value) {
		super(value);
	}
