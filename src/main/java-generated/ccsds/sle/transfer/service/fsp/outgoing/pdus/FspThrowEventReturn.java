...
public class FspThrowEventReturn implements BerType, Serializable {
	...
	public static class Result implements BerType, Serializable {
		...
		private DiagnosticFspThrowEvent negativeResult = null;
		...
		public void setNegativeResult(DiagnosticFspThrowEvent negativeResult) {
			this.negativeResult = negativeResult;
		}

		public DiagnosticFspThrowEvent getNegativeResult() {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
				...
				negativeResult = new DiagnosticFspThrowEvent();
	...
	private IntUnsignedLong eventInvokeId = null;
	private Result result = null;
	
	public FspThrowEventReturn() {
	}

	public FspThrowEventReturn(byte[] code) {
		this.code = code;
	}
	...
	public void setEventInvokeId(IntUnsignedLong eventInvokeId) {
		this.eventInvokeId = eventInvokeId;
	}

	public IntUnsignedLong getEventInvokeId() {
		return eventInvokeId;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		codeLength += eventInvokeId.encode(reverseOS, true);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(IntUnsignedLong.tag)) {
			eventInvokeId = new IntUnsignedLong();
			subCodeLength += eventInvokeId.decode(is, false);
			subCodeLength += berTag.decode(is);
		}
		else {
			throw new IOException("Tag does not match the mandatory sequence element tag.");
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (eventInvokeId != null) {
			sb.append("eventInvokeId: ").append(eventInvokeId);
		}
		else {
			sb.append("eventInvokeId: <empty-required-field>");
		}
