...
public class FspInvokeDirectiveReturn implements BerType, Serializable {
	...
	public static class Result implements BerType, Serializable {
		...
		private DiagnosticFspInvokeDirective negativeResult = null;
		...
		public void setNegativeResult(DiagnosticFspInvokeDirective negativeResult) {
			this.negativeResult = negativeResult;
		}

		public DiagnosticFspInvokeDirective getNegativeResult() {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
				...
				negativeResult = new DiagnosticFspInvokeDirective();
	...
	public FspInvokeDirectiveReturn() {
	}

	public FspInvokeDirectiveReturn(byte[] code) {
		this.code = code;
	}
