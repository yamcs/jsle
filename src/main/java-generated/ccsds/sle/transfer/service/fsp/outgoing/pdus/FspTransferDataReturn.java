...
public class FspTransferDataReturn implements BerType, Serializable {
	...
	public static class Result implements BerType, Serializable {
		...
		private DiagnosticFspTransferData negativeResult = null;
		...
		public void setNegativeResult(DiagnosticFspTransferData negativeResult) {
			this.negativeResult = negativeResult;
		}

		public DiagnosticFspTransferData getNegativeResult() {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
				...
				negativeResult = new DiagnosticFspTransferData();
	...
	private PacketIdentification expectedPacketIdentification = null;
	private BufferSize packetBufferAvailable = null;
	private Result result = null;
	
	public FspTransferDataReturn() {
	}

	public FspTransferDataReturn(byte[] code) {
		this.code = code;
	}
	...
	public void setExpectedPacketIdentification(PacketIdentification expectedPacketIdentification) {
		this.expectedPacketIdentification = expectedPacketIdentification;
	}

	public PacketIdentification getExpectedPacketIdentification() {
		return expectedPacketIdentification;
	}

	public void setPacketBufferAvailable(BufferSize packetBufferAvailable) {
		this.packetBufferAvailable = packetBufferAvailable;
	}

	public BufferSize getPacketBufferAvailable() {
		return packetBufferAvailable;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		codeLength += packetBufferAvailable.encode(reverseOS, true);
		
		codeLength += expectedPacketIdentification.encode(reverseOS, true);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(PacketIdentification.tag)) {
			expectedPacketIdentification = new PacketIdentification();
			subCodeLength += expectedPacketIdentification.decode(is, false);
			subCodeLength += berTag.decode(is);
		}
		else {
			throw new IOException("Tag does not match the mandatory sequence element tag.");
		...
		if (berTag.equals(BufferSize.tag)) {
			packetBufferAvailable = new BufferSize();
			subCodeLength += packetBufferAvailable.decode(is, false);
			subCodeLength += berTag.decode(is);
		}
		else {
			throw new IOException("Tag does not match the mandatory sequence element tag.");
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (expectedPacketIdentification != null) {
			sb.append("expectedPacketIdentification: ").append(expectedPacketIdentification);
		}
		else {
			sb.append("expectedPacketIdentification: <empty-required-field>");
		}
		...
		if (packetBufferAvailable != null) {
			sb.append("packetBufferAvailable: ").append(packetBufferAvailable);
		}
		else {
			sb.append("packetBufferAvailable: <empty-required-field>");
		}
