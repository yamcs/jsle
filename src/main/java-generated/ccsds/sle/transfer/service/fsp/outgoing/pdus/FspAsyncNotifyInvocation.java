...
public class FspAsyncNotifyInvocation implements BerType, Serializable {
	...
	private FspNotification fspNotification = null;
	private FspPacketLastProcessed fspPacketLastProc = null;
	private FspPacketLastOk fspPacketLastOk = null;
	private FspProductionStatus productionStatus = null;
	
	public FspAsyncNotifyInvocation() {
	}

	public FspAsyncNotifyInvocation(byte[] code) {
		this.code = code;
	}
	...
	public void setFspNotification(FspNotification fspNotification) {
		this.fspNotification = fspNotification;
	}

	public FspNotification getFspNotification() {
		return fspNotification;
	}

	public void setFspPacketLastProc(FspPacketLastProcessed fspPacketLastProc) {
		this.fspPacketLastProc = fspPacketLastProc;
	}

	public FspPacketLastProcessed getFspPacketLastProc() {
		return fspPacketLastProc;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		codeLength += fspPacketLastProc.encode(reverseOS);
		
		codeLength += fspNotification.encode(reverseOS);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		fspNotification = new FspNotification();
		subCodeLength += fspNotification.decode(is, berTag);
		subCodeLength += berTag.decode(is);
		
		fspPacketLastProc = new FspPacketLastProcessed();
		subCodeLength += fspPacketLastProc.decode(is, berTag);
		subCodeLength += berTag.decode(is);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (fspNotification != null) {
			sb.append("fspNotification: ");
			fspNotification.appendAsString(sb, indentLevel + 1);
		}
		else {
			sb.append("fspNotification: <empty-required-field>");
		}
		...
		if (fspPacketLastProc != null) {
			sb.append("fspPacketLastProc: ");
			fspPacketLastProc.appendAsString(sb, indentLevel + 1);
		}
		else {
			sb.append("fspPacketLastProc: <empty-required-field>");
		}
