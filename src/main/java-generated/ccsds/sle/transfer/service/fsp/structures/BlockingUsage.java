...
public class BlockingUsage extends BerInteger {

	private static final long serialVersionUID = 1L;

	public BlockingUsage() {
	}

	public BlockingUsage(byte[] code) {
		super(code);
	}

	public BlockingUsage(BigInteger value) {
		super(value);
	}

	public BlockingUsage(long value) {
		super(value);
	}
