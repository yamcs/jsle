...
public class DirectiveExecutedId extends IntUnsignedLong {

	private static final long serialVersionUID = 1L;

	public DirectiveExecutedId() {
	}

	public DirectiveExecutedId(byte[] code) {
		super(code);
	}

	public DirectiveExecutedId(BigInteger value) {
		super(value);
	}

	public DirectiveExecutedId(long value) {
		super(value);
	}
