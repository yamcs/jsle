...
public class PacketIdentification extends IntUnsignedLong {
	...
	public PacketIdentification(byte[] code) {
		super(code);
	}

	public PacketIdentification(BigInteger value) {
		super(value);
	}

	public PacketIdentification(long value) {
		super(value);
	}
