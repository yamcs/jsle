...
public class FspGetParameterInvocation implements BerType, Serializable {
	...
	private FspParameterName fspParameterName = null;
	
	public FspGetParameterInvocation() {
	}

	public FspGetParameterInvocation(byte[] code) {
		this.code = code;
	}
	...
	public void setFspParameterName(FspParameterName fspParameterName) {
		this.fspParameterName = fspParameterName;
	}

	public FspParameterName getFspParameterName() {
		return fspParameterName;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += fspParameterName.encode(reverseOS, true);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(FspParameterName.tag)) {
			fspParameterName = new FspParameterName();
			subCodeLength += fspParameterName.decode(is, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (fspParameterName != null) {
			sb.append("fspParameterName: ").append(fspParameterName);
		}
		else {
			sb.append("fspParameterName: <empty-required-field>");
		}
