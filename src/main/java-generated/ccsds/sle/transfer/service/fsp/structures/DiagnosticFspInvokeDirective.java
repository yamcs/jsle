...
public class DiagnosticFspInvokeDirective implements BerType, Serializable {
	...
	public DiagnosticFspInvokeDirective() {
	}

	public DiagnosticFspInvokeDirective(byte[] code) {
		this.code = code;
	}
