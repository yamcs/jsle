...
public class FspParameterName extends ParameterName {

	private static final long serialVersionUID = 1L;

	public FspParameterName() {
	}

	public FspParameterName(byte[] code) {
		super(code);
	}

	public FspParameterName(BigInteger value) {
		super(value);
	}

	public FspParameterName(long value) {
		super(value);
	}
