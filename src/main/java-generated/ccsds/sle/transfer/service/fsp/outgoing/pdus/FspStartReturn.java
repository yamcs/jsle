...
public class FspStartReturn implements BerType, Serializable {
	...
	public static class Result implements BerType, Serializable {
		...
		public static class PositiveResult implements BerType, Serializable {
			...
			public byte[] code = null;
			private Time startProductionTime = null;
			private ConditionalTime stopProductionTime = null;
			
			public PositiveResult() {
			}

			public PositiveResult(byte[] code) {
				this.code = code;
			}

			public void setStartProductionTime(Time startProductionTime) {
				this.startProductionTime = startProductionTime;
			}

			public Time getStartProductionTime() {
				return startProductionTime;
			}

			public void setStopProductionTime(ConditionalTime stopProductionTime) {
				this.stopProductionTime = stopProductionTime;
			}

			public ConditionalTime getStopProductionTime() {
				return stopProductionTime;
			}
			...
			public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
				...
				int codeLength = 0;
				codeLength += stopProductionTime.encode(reverseOS);
				
				codeLength += startProductionTime.encode(reverseOS);
			...
			public int decode(InputStream is, boolean withTag) throws IOException {
				...
				startProductionTime = new Time();
				subCodeLength += startProductionTime.decode(is, berTag);
				subCodeLength += berTag.decode(is);
				
				stopProductionTime = new ConditionalTime();
				subCodeLength += stopProductionTime.decode(is, berTag);
			...
			public void appendAsString(StringBuilder sb, int indentLevel) {
				...
				if (startProductionTime != null) {
					sb.append("startProductionTime: ");
					startProductionTime.appendAsString(sb, indentLevel + 1);
				}
				else {
					sb.append("startProductionTime: <empty-required-field>");
				}
				...
				if (stopProductionTime != null) {
					sb.append("stopProductionTime: ");
					stopProductionTime.appendAsString(sb, indentLevel + 1);
				}
				else {
					sb.append("stopProductionTime: <empty-required-field>");
				}
		...
		private PositiveResult positiveResult = null;
		private DiagnosticFspStart negativeResult = null;
		...
		public void setPositiveResult(PositiveResult positiveResult) {
			this.positiveResult = positiveResult;
		}

		public PositiveResult getPositiveResult() {
			return positiveResult;
		}

		public void setNegativeResult(DiagnosticFspStart negativeResult) {
			this.negativeResult = negativeResult;
		}

		public DiagnosticFspStart getNegativeResult() {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 0)) {
				positiveResult = new PositiveResult();
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
				...
				negativeResult = new DiagnosticFspStart();
	...
	public FspStartReturn() {
	}

	public FspStartReturn(byte[] code) {
		this.code = code;
	}
