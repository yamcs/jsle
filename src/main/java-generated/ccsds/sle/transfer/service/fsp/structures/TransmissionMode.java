...
public class TransmissionMode extends BerInteger {
	...
	public TransmissionMode(byte[] code) {
		super(code);
	}

	public TransmissionMode(BigInteger value) {
		super(value);
	}

	public TransmissionMode(long value) {
		super(value);
	}
