...
public class FspStartInvocation implements BerType, Serializable {
	...
	private PacketIdentification firstPacketIdentification = null;
	
	public FspStartInvocation() {
	}

	public FspStartInvocation(byte[] code) {
		this.code = code;
	}
	...
	public void setFirstPacketIdentification(PacketIdentification firstPacketIdentification) {
		this.firstPacketIdentification = firstPacketIdentification;
	}

	public PacketIdentification getFirstPacketIdentification() {
		return firstPacketIdentification;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += firstPacketIdentification.encode(reverseOS, true);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(PacketIdentification.tag)) {
			firstPacketIdentification = new PacketIdentification();
			subCodeLength += firstPacketIdentification.decode(is, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (firstPacketIdentification != null) {
			sb.append("firstPacketIdentification: ").append(firstPacketIdentification);
		}
		else {
			sb.append("firstPacketIdentification: <empty-required-field>");
		}
