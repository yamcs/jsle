...
public class NumberOfCltusProcessed extends IntUnsignedLong {

	private static final long serialVersionUID = 1L;

	public NumberOfCltusProcessed() {
	}

	public NumberOfCltusProcessed(byte[] code) {
		super(code);
	}

	public NumberOfCltusProcessed(BigInteger value) {
		super(value);
	}

	public NumberOfCltusProcessed(long value) {
		super(value);
	}
