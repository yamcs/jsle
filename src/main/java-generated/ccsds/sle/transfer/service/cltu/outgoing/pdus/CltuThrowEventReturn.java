...
public class CltuThrowEventReturn implements BerType, Serializable {
	...
	public static class Result implements BerType, Serializable {
		...
		private DiagnosticCltuThrowEvent negativeResult = null;
		...
		public void setNegativeResult(DiagnosticCltuThrowEvent negativeResult) {
			this.negativeResult = negativeResult;
		}

		public DiagnosticCltuThrowEvent getNegativeResult() {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
				...
				negativeResult = new DiagnosticCltuThrowEvent();
	...
	private EventInvocationId eventInvocationIdentification = null;
	private Result result = null;
	
	public CltuThrowEventReturn() {
	}

	public CltuThrowEventReturn(byte[] code) {
		this.code = code;
	}
	...
	public void setEventInvocationIdentification(EventInvocationId eventInvocationIdentification) {
		this.eventInvocationIdentification = eventInvocationIdentification;
	}

	public EventInvocationId getEventInvocationIdentification() {
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(EventInvocationId.tag)) {
			eventInvocationIdentification = new EventInvocationId();
