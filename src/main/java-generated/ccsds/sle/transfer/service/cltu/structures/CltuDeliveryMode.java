...
public class CltuDeliveryMode extends DeliveryMode {

	private static final long serialVersionUID = 1L;

	public CltuDeliveryMode() {
	}

	public CltuDeliveryMode(byte[] code) {
		super(code);
	}

	public CltuDeliveryMode(BigInteger value) {
		super(value);
	}

	public CltuDeliveryMode(long value) {
		super(value);
	}
