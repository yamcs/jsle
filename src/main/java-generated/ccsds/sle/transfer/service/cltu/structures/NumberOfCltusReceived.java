...
public class NumberOfCltusReceived extends IntUnsignedLong {

	private static final long serialVersionUID = 1L;

	public NumberOfCltusReceived() {
	}

	public NumberOfCltusReceived(byte[] code) {
		super(code);
	}

	public NumberOfCltusReceived(BigInteger value) {
		super(value);
	}

	public NumberOfCltusReceived(long value) {
		super(value);
	}
