...
public class CltuGetParameterReturn implements BerType, Serializable {
	...
	public static class Result implements BerType, Serializable {
		...
		private CltuGetParameter positiveResult = null;
		private DiagnosticCltuGetParameter negativeResult = null;
		...
		public void setPositiveResult(CltuGetParameter positiveResult) {
			this.positiveResult = positiveResult;
		}

		public CltuGetParameter getPositiveResult() {
			return positiveResult;
		}

		public void setNegativeResult(DiagnosticCltuGetParameter negativeResult) {
			this.negativeResult = negativeResult;
		}

		public DiagnosticCltuGetParameter getNegativeResult() {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 0)) {
				...
				positiveResult = new CltuGetParameter();
	...
	public CltuGetParameterReturn() {
	}

	public CltuGetParameterReturn(byte[] code) {
		this.code = code;
	}
