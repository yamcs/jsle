...
public class CltuStartReturn implements BerType, Serializable {
	...
	public static class Result implements BerType, Serializable {
		...
		public static class PositiveResult implements BerType, Serializable {
			...
			public byte[] code = null;
			private Time startRadiationTime = null;
			private ConditionalTime stopRadiationTime = null;
			...
			public void setStartRadiationTime(Time startRadiationTime) {
				this.startRadiationTime = startRadiationTime;
			}

			public Time getStartRadiationTime() {
				return startRadiationTime;
			}

			public void setStopRadiationTime(ConditionalTime stopRadiationTime) {
				this.stopRadiationTime = stopRadiationTime;
			}

			public ConditionalTime getStopRadiationTime() {
				return stopRadiationTime;
			}
			...
			public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
				...
				int codeLength = 0;
				codeLength += stopRadiationTime.encode(reverseOS);
			...
			public int decode(InputStream is, boolean withTag) throws IOException {
				...
				startRadiationTime = new Time();
				subCodeLength += startRadiationTime.decode(is, berTag);
				subCodeLength += berTag.decode(is);
				
				stopRadiationTime = new ConditionalTime();
				subCodeLength += stopRadiationTime.decode(is, berTag);
			...
			public void appendAsString(StringBuilder sb, int indentLevel) {
				...
				if (stopRadiationTime != null) {
					sb.append("stopRadiationTime: ");
					stopRadiationTime.appendAsString(sb, indentLevel + 1);
				}
				else {
					sb.append("stopRadiationTime: <empty-required-field>");
				}
		...
		private DiagnosticCltuStart negativeResult = null;
		...
		public void setNegativeResult(DiagnosticCltuStart negativeResult) {
			this.negativeResult = negativeResult;
		}

		public DiagnosticCltuStart getNegativeResult() {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
				...
				negativeResult = new DiagnosticCltuStart();
	...
	public CltuStartReturn() {
	}

	public CltuStartReturn(byte[] code) {
		this.code = code;
	}
