...
public class EventInvocationId extends IntUnsignedLong {

	private static final long serialVersionUID = 1L;

	public EventInvocationId() {
	}

	public EventInvocationId(byte[] code) {
		super(code);
	}

	public EventInvocationId(BigInteger value) {
		super(value);
	}

	public EventInvocationId(long value) {
		super(value);
	}
