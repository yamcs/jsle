...
public class CltuTransferDataReturn implements BerType, Serializable {
	...
	public static class Result implements BerType, Serializable {
		...
		private DiagnosticCltuTransferData negativeResult = null;
		...
		public void setNegativeResult(DiagnosticCltuTransferData negativeResult) {
			this.negativeResult = negativeResult;
		}

		public DiagnosticCltuTransferData getNegativeResult() {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
				...
				negativeResult = new DiagnosticCltuTransferData();
	...
	public CltuTransferDataReturn() {
	}

	public CltuTransferDataReturn(byte[] code) {
		this.code = code;
	}
