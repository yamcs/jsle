...
public class GvcId implements BerType, Serializable {
	...
	public static class VcId implements BerType, Serializable {
		...
		private ccsds.sle.transfer.service.cltu.structures.VcId virtualChannel = null;
		...
		public void setVirtualChannel(ccsds.sle.transfer.service.cltu.structures.VcId virtualChannel) {
			this.virtualChannel = virtualChannel;
		}

		public ccsds.sle.transfer.service.cltu.structures.VcId getVirtualChannel() {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 1)) {
				virtualChannel = new ccsds.sle.transfer.service.cltu.structures.VcId();
